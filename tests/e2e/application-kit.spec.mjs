...
test('vacancy analysis creates an editable local application kit with exports', async ({ page }) => {
  ...
  await expect(editor).toContainText('Application Kit');
  await expect(editor).toContainText('I do not present Kubernetes as existing experience');
