const SHELL_CACHE = 'auto-resume-v2.2-shell-v1';
const RUNTIME_CACHE = 'auto-resume-v2.2-runtime-v1';
const APP_SHELL = [
  ...
  './js/vacancy.mjs', './js/preferences.mjs', './js/compare.mjs', './js/workspace.mjs',
];
