...
const dictionaries = {
  ru: {
    'meta.title': 'Auto Resume v2.4 — GitHub Resume Generator',
    'meta.description': 'Auto Resume v2.4 — двуязычный PWA-генератор резюме по GitHub с локальными черновиками, сравнением профилей и ATS-экспортом.',
    ...
    'footer': 'GitHub GraphQL API · Auto Resume v2.4 · RU/EN, PWA, локальные черновики и резервные копии',
  ...
  en: {
    'meta.title': 'Auto Resume v2.4 — GitHub Resume Generator',
    'meta.description': 'Auto Resume v2.4 — a bilingual PWA resume generator powered by GitHub, with local drafts, profile comparison and ATS export.',
    ...
    'footer': 'GitHub GraphQL API · Auto Resume v2.4 · RU/EN, PWA, local drafts and backups',
